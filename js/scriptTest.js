...
// headingMsg.innerHTML = "شيء ما خاطئ";
// fixMsg.innerHTML = "تأكد من إدخال اسم مدينة صالح";
// fixBox.classList.add("notificationMsg");
// fixBox.appendChild(headingMsg);
// fixBox.appendChild(fixMsg);
